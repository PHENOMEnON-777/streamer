...
@router.post('/createStationService', status_code=status.HTTP_201_CREATED, response_model=schemas.ShowStationService)
...
@router.get('/allStationServices', status_code=status.HTTP_200_OK, )
...
@router.put('/updateStationService/{id}', status_code=status.HTTP_200_OK, response_model=schemas.ShowStationService)
...
@router.delete('/stationService/{id}', status_code=status.HTTP_200_OK)
